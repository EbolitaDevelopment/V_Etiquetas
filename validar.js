//Editado por Maldonado Alcala Leonardo 6IV8
function validar(form) {
    ...
    if (contieneEtiquetaHTML(nombre)===true||contieneEtiquetaHTML(edad)===true||contieneEtiquetaHTML(sexo)===true||contieneEtiquetaHTML(deporte)===true) {
        alert("Por favor, no intente ingresar etiquetas HTML al back.");
        sexo = null;
        deporte = null;
        edad = null;
        nombre = null;
